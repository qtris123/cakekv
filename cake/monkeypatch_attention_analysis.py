import transformers
from cake.model.modify_llama_attention_analysis import llama_model_forward_cake_with_analysis, llama_attn_forward_cake_with_analysis
...
def replace_flashllama_attn_with_cakeattn_analysis():
    transformers.models.llama.modeling_llama.LlamaModel.forward = llama_model_forward_cake_with_analysis
    transformers.models.llama.modeling_llama.LlamaFlashAttention2.forward = llama_attn_forward_cake_with_analysis
